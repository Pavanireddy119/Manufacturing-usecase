...
CONFIG = {
    # Dataset
    'data_yaml': 'datasets/dataset_final/data.yaml',
    'dataset_path': 'datasets/dataset_final',
...
def prepare_yolo_data(data_yaml_path):
    ...
    working_yaml_path = Path('datasets/dataset_final/data_yolov8.yaml')
...
def main():
    ...
    print(f"{'='*60}")
    print(f"\nOutput files:")
    print(f"  - Models: outputs/model_outputs/models/best.pt, outputs/model_outputs/models/last.pt")
    print(f"  - Exported: outputs/model_outputs/models/best.onnx, outputs/model_outputs/models/best.torchscript")
    print(f"  - Reports: outputs/model_outputs/reports/")
