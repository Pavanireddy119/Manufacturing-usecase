...
def train_model():
    ...
    params = {
        ...
        'project': 'outputs/model_outputs/runs/detect',
        'exist_ok': False,
        'verbose': True,
        'save': True,
        'save_period': -1,
    ...
    # Save best model
    best_model_path = Path("outputs/model_outputs/runs/detect/damage_detection_v1/weights/best.pt")
    if best_model_path.exists():
        # Copy to main directory
        import shutil
        output_path = Path("models/best_damage_model.pt")
