...
# ============================================================
BASE_DIR = Path.cwd()
DATASET_DIR = BASE_DIR / 'Dataset' / 'data1a'
OUTPUT_DIR = BASE_DIR / 'dataset_labeled'
...
def copy_preprocessed_images():
    ...
    preproc_dir = BASE_DIR / 'preprocessed_dataset'
...
def main():
    ...
    print(f"  3. Train YOLOv8 with: yolo train data={OUTPUT_DIR}/data.yaml model=yolov8n.pt epochs=100")
    print("=" * 70)
