...
def evaluate_model(model, data_yaml, output_dir='outputs/model_outputs/reports'):
...
def main():
    ...
    # Paths
    model_path = 'outputs/model_outputs/models/best.pt'
    data_yaml = 'datasets/dataset_final/data_yolov8.yaml'
    if not Path(data_yaml).exists():
        data_yaml = 'datasets/dataset_final/data.yaml'
    
    output_dir = Path('outputs/model_outputs/reports')
    output_dir.mkdir(parents=True, exist_ok=True)
