...
# Paths
MODEL_PATH = 'outputs/model_outputs/yolo_fixed/weights/best.pt'
TEST_IMAGES_DIR = 'datasets/dataset_yolo_fixed/images/test'
TEST_LABELS_DIR = 'datasets/dataset_yolo_fixed/labels/test'
DATA_YAML = 'datasets/dataset_yolo_fixed/data.yaml'
OUTPUT_DIR = 'outputs/predictions/predictions_fixed'
REPORTS_DIR = 'outputs/model_outputs/reports_fixed'
...
def generate_report(metrics, per_class):
    ...
    with open(REPORT_TXT, 'w') as f:
        ...
        f.write("-" * 50 + "\n")
        f.write("  Dataset: datasets/dataset_yolo_fixed/\n")
...
def main():
    ...
    import shutil
    train_dir = 'outputs/model_outputs/yolo_fixed'
