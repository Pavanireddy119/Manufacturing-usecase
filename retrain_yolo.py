...
# Config
DATA_YAML = os.path.abspath('dataset_yolo_restructured/damage_only.yaml')
MODEL_NAME = 'yolov8s'
EPOCHS = 100
IMG_SIZE = 640
BATCH = -1  # auto-batch
...
# Copy best model
src = Path('output/retrained/weights/best.pt')
dst = Path('output/models/yolov8s_damage.pt')
...
print(f"  - output/retrained/")
print(f"  - output/models/yolov8s_damage.pt")